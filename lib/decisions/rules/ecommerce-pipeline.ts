    ...
    return [
      {
        ...
        reasoning: `These products have margin ≥ ${(min_margin * 100).toFixed(0)}%, ${min_days_cover}+ days of cover, and are class A or B — strong candidates to list online. Sorted by margin.`,
