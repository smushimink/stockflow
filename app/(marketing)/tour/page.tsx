...
export const metadata = {
  title: "Product Tour — Stockflow",
  description: "See how Stockflow turns your inventory and sales data into daily decisions.",
};
      ...
      <main className="min-h-screen bg-[#F7F7F5] pt-14">
        <div className="max-w-3xl mx-auto px-5 py-24 text-center">
          ...
          <p className="text-[17px] text-[#5C5C57] leading-relaxed mb-10">
            An interactive walkthrough of Stockflow is in the works. In the meantime, sign up for early access and we&apos;ll walk you through it personally.
          </p>
          <Link
            href="/signup"
