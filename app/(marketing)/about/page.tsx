    ...
    <>
      ...
      <main className="min-h-screen bg-[#F7F7F5] pt-14">
        <div className="max-w-3xl mx-auto px-5 py-24">
          ...
          <h1 className="text-4xl font-700 text-[#1A1A17] tracking-tight mb-6">About Stockflow</h1>
          <div className="space-y-5 text-[16px] text-[#5C5C57] leading-relaxed">
            <p>
              Stockflow started with a simple observation: wholesale and distribution businesses are sitting on
            ...
            <p>
              We built Stockflow to close that gap. Not by replacing your systems, but by reading them and
